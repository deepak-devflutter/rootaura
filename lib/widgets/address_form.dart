          ...
          child: Column(
            ...
            children: [
              Text(widget.existing == null ? 'Add Address' : 'Edit Address',
                  style:
                      AppTextStyles.h3.copyWith(color: brand.textPrimary)),
              ...
              _field(brand, _phone, 'Phone number',
                  phone: true, formatters: [
                    FilteringTextInputFormatter.digitsOnly,
                    LengthLimitingTextInputFormatter(10),
                  ]),
              _field(brand, _line1, 'Address line 1'),
              _field(brand, _line2, 'Address line 2 (optional)',
                  required: false),
              Row(children: [
              ...
              _field(brand, _pincode, 'Pincode', formatters: [
                FilteringTextInputFormatter.digitsOnly,
